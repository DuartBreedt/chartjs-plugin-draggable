/*!
* chartjs-plugin-draggable v0.2.6
* Huh?
...
class DraggableElementAccessor {
	static isSupported() {
		return true;
	}
...
class DraggableLineAnnotationElement extends DraggableElement {
	constructor(chartInstance, elementConfig) {
...
class DraggablePointAnnotationElement extends DraggableElement {
	constructor(chartInstance, elementConfig) {
		super(chartInstance, elementConfig);
		this.scale = this.chart.scales[elementConfig.scaleID];
	}
...
class DraggableAnnotationAccessor extends DraggableElementAccessor {
	static isSupported() {
		return true
	}
